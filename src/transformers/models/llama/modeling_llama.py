...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig, layer_idx: Optional[int] = None):
        ...
        if self.palu_kv_compression_enabled:
            ...
            self.palu_k_up_proj = nn.Linear(self.num_key_value_heads * config.palu_head_dim, self.num_key_value_heads * self.head_dim, bias=config.attention_bias)
            self.palu_v_up_proj = nn.Linear(self.num_key_value_heads * config.palu_head_dim, self.num_key_value_heads * self.head_dim, bias=config.attention_bias)
